...
with PythonPath("..", relative_to=__file__):
    from data_pipeline import SILENCE_LABEL, UNKNOWN_WORD_LABEL
...
class StreamingAccuracyStats(object):
    ...
    def calculate_accuracy_stats(self, found_words, up_to_time_ms, time_tolerance_ms):
        ...
        for ground_truth in self._gt_occurrence:
            ...
            if (
                ground_truth_label == SILENCE_LABEL
                or ground_truth_label == UNKNOWN_WORD_LABEL
            ):
        ...
        for found_word in found_words:
            ...
            for ground_truth in self._gt_occurrence:
                ...
                if (
                    ...
                    if (
                        ground_truth_label == "_unknown_"
                        or ground_truth_label == "_silence_"
        ...
        for ground_truth in gt_so_far:
            ...
            for found_word in found_words:
                ...
                if (
                    ground_truth_time < latest_time
                    and ground_truth_time > earliest_time
                ):
    ...
    def print_accuracy_stats(self):
        ...
        if self._how_many_gt == 0:
            ...
            #     self._how_many_fp))
            print("No ground truth yet, {}false positives".format(self._how_many_fp))
        else:
            ...
            info = (
                ...
                "{:.1f} howmanyfp, {:.1f} howmanyfn".format(
